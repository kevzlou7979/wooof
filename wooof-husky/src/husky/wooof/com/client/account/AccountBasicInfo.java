...
public class AccountBasicInfo extends Composite {
	...
	private static AccountBasicInfoUiBinder uiBinder = GWT.create(AccountBasicInfoUiBinder.class);

	interface AccountBasicInfoUiBinder extends UiBinder<Widget, AccountBasicInfo> {
	}

	@UiField
	HuskyEditableLabel lblFirstName, lblLastName, lblEmail, lblGender;
	@UiField
	Image btnEdit;
	@UiField
	FocusPanel panel;
	...
	@UiField
	HTMLPanel editablePanel, actionPanel, messagePanel;
